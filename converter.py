...
class Zipfile2JsonL:
    def __init__(self, output_root, chunk_counter, target_encoding="utf-8", clean_src_file=False, plateform="bitbucket", author=""):
    ...
    def get_jsonl_file(self):
        return self.output / f"bitbucketcode.{self.chunk_counter}.jsonl"
